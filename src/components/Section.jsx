...
export function SkillSection({skilldata}) {
  ...
  <div className="box">
    <div className="circle" style={{ left: (Number(skilldata.level) * 9.8) + "%"}} />
      <div className="level">
        <div className="fill" style={{ width: (Number(skilldata.level) * 9.8) + "%" }} />
      </div>
  </div>
</div>
)
...
export function AchievementsSection({achievementdata}) {
 return(<div className="section achievements">
  ...
  <div className="achievements">
    <ul id="achievements">{achievementdata.map(achievement => <li>{achievement.content}</li>)}</ul>
  </div>
</div>)
}
